...
const rows = [
  createData('MMC Transform, Our Approach',0.9532,0.3945,0.7273,0.3348,0.0048,26,2.3493,0.1652,0.0177,1.1266,57.3),
  createData('PCA/LDA Transform, Base Paper',0.9607,0.4389,0.7098,0.3384,0.0038,27,2.8163,0.1417,-0.0263,1.0162,108),
        ...
        <Table sx={{ minWidth: 650 }} size="small" aria-label="a dense table">
          ...
          <TableBody>
            {rows.map((row, index) => (
                <TableRow 
                key={row.Method} 
                sx={{ color: 'white', fontWeight: index === 0 ? 'bold' : 'normal', '&:hover': {
                    backgroundColor: 'rgba(255, 255, 255, 0.1)',
                  }, }}
                >
                <TableCell component="th" scope="row" sx={{ color: index === 0 ? 'red' : 'white' }}>
                    {row.Method}
                </TableCell>
